...
export interface ProductsDataTableItem {
  id: number;
  category: string;
  picture: string;
  price: number;
...
const EXAMPLE_DATA: ProductsDataTableItem[] = [
  {id:4, category:"fruit", picture:"tomato", price:24, sellingMode:"box", availability:"available"},
...
export class ProductsDataTableDataSource extends DataSource<ProductsDataTableItem> {
   ...
   */
  connect(): Observable<ProductsDataTableItem[]> {
   ...
   */
  private getPagedData(data: ProductsDataTableItem[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: ProductsDataTableItem[]) {
